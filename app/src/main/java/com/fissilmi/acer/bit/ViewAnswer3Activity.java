...
import com.fissilmi.acer.bit.db.DBAdapterthree;
...
public class ViewAnswer3Activity extends AppCompatActivity {
    ...
    private ViewAnswer3Activity.CustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ViewAnswer3Activity.CustomAdapter(ViewAnswer3Activity.this, R.layout.list_row,
                originalValues);
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>> {
        ...
        ViewAnswer3Activity.CustomAdapter.ViewHolder viewHolder;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder = new ViewAnswer3Activity.CustomAdapter.ViewHolder();
                ...
                viewHolder = (ViewAnswer3Activity.CustomAdapter.ViewHolder) convertView.getTag();
