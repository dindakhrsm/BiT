...
import com.fissilmi.acer.bit.db.DBListeningone;
...
public class Listening1Activity extends Activity {
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Listening1Activity.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Coba Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            Listening1Activity.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
