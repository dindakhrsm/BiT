...
import com.fissilmi.acer.bit.db.DBListeningtwo;
...
public class Listening2Activity extends Activity {

    private DBListeningtwo db;
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Listening2Activity.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Coba Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            noSalah="";
                            java.util.Arrays.fill(jawabanYgDiPilih, -2);
                            Listening2Activity.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "Kembali",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            cekPertanyaan = false;
                            finish();
                            Intent quizlistening = new Intent(Listening2Activity.this,MainActivity.class);
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEGATIVE, "Kembali",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            cekPertanyaan = false;
                            finish();
                            Intent quizlistening2 =new Intent(Listening2Activity.this,MainActivity.class);
                            startActivity(quizlistening2);
                        }
                    });
